...
export default function Exercise() {
  ...
  useEffect(() => {
    axios(backendApiLink + `Task/${currentTaskId}`).then((result) => {
  ...
  const submitCode = (event) => {
    ...
    axios
      .post(backendApiLink + "code/checker", request, {
          ...
          <div className="submitButtonDiv">
            ...
            {solutionData != undefined ? (
              <div className="stats" style={{ color: "white" }}>
                ...
                <p>
                  Correctness Points: {solutionData.taskPoints}, RunTime Points:{" "}
                  {solutionData.runTimePoints}, RAM Usage Points:{" "}
                  {solutionData.memoryUsagePoints}
                </p>
              </div>
            ) : (
              <></>
